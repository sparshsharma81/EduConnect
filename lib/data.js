...
export const features = [
  {
    ...
    description:
      "Sign up and complete your profile to get personalized education recommendations and services.",
  },
  {
    icon: <Calendar className="h-6 w-6 text-emerald-400" />,
    title: "Book Appointments",
    description:
      "Browse Mentor profiles, check availability, and book appointments that fit your schedule.",
  },
  {
    icon: <Video className="h-6 w-6 text-emerald-400" />,
    title: "Video Consultation",
    description:
      "Connect with Mentors through secure, high-quality video consultations from the comfort of your home.",
  },
  {
    icon: <CreditCard className="h-6 w-6 text-emerald-400" />,
    title: "Consultation Credits",
    description:
      "Purchase credit packages that fit your education needs with our simple subscription model.",
  },
  {
    icon: <ShieldCheck className="h-6 w-6 text-emerald-400" />,
    title: "Verified Doctors",
    description:
      "All education providers are carefully vetted and verified to ensure quality education.",
  },
  {
    icon: <FileText className="h-6 w-6 text-emerald-400" />,
    title: "Education Documentation",
    description:
      "Access and manage your appointment history, Mentor's notes, and education recommendations.",
  },
];
...
export const testimonials = [
  {
    ...
    role: "Patient",
    quote:
      "The video consultation feature saved me so much time. I was able to get education advice without taking time off work or traveling to a clinic.",
  },
  {
    initials: "DR",
    name: "Dr. Robert M.",
