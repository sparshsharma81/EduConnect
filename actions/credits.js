...
export async function checkAndAllocateCredits(user) {
  try {
    if (!user) {
      ...
      //if user is not present..we will be returning null
    }
    ...
    let currentPlan = null; //ye basically ham check krege user ka current plan 
    ...
    //now in order to make it work..we have to install the date library 
    //npm i date-fns
